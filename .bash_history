...
cd /mnt/gentoo/
wget http://gentoo.channelx.biz/releases/amd64/current-stage3/stage3-amd64-20130606.tar.bz2
tar xvjpf stage3-*.tar.bz2
wget http://gentoo.channelx.biz/snapshots/portage-latest.tar.bz2
tar xvjf portage-latest.tar.bz2 -C /mnt/gentoo/usr
rm stage3-*.tar.bz2* portage-latest.tar.bz2*
wget https://raw.github.com/bleuscr/gentoo/master/etc/portage/make.conf -O /mnt/gentoo/etc/portage/make.conf
